    ...
    <Popover.Root>
      <Popover.Trigger
        className={clsx("w-10 h-10 bg-zinc-900 border-2 border-zinc-800 rounded-lg", {
          ...
          'bg-violet-900 border-violet-800': comlpetedPercentage > 0 && comlpetedPercentage < 20,
          'bg-violet-800 border-violet-700': comlpetedPercentage >= 20 && comlpetedPercentage < 40,
          'bg-violet-700 border-violet-600': comlpetedPercentage >= 40 && comlpetedPercentage < 60,
